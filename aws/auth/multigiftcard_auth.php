...
'total','cvv','invoice','tax'
	...
	$reqNotEmpty = array('location_id','salon_id','creditcard','expiration','total','cvv');
   ...
   $query = mysql_query("SELECT * FROM `plus_location` WHERE `id`=".mysql_real_escape_string($location_id)." LIMIT 1;");
