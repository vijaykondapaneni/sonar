...
class OwnerServiceSalesDataForGraphsLastYear extends CI_Controller
{
    /**
    AUTHOR: Subbu
    ...
    **/
    ...
    function __getStartEndDate($dayRangeType,$year)
    {
     ...
     */
    function setOwnerServiceSalesDataForGraphsLastYear($dayRangeType="today",$year=1,$salon_id="")
        { 
                   ...
                   if(!in_array($salon_id, $processedSalons))
                    {
                      ...
                      if(!empty($salonDetails)&& isset($salonDetails['salon_info']["millennium_enabled"]) && isset($salonDetails['salon_info']["service_retail_reports_enabled"]) && $salonDetails['salon_info']["millennium_enabled"]=="Yes" && $salonDetails['salon_info']["service_retail_reports_enabled"]=="Yes"){
                        ...
                        $log['whichCron'] = 'setOwnerServiceSalesDataForGraphsLastYear';
                                        ...
                                        if(!empty($reportsDataForSalon)){
                                             ...
                                             if(empty($diff_array)){
                                               pa('No Updates');
                                                ...
                                                // update
                                                $diff_array['insert_status'] = OwnerServiceSalesDataForGraphsLastYear::UPDATED;
                                            ...
                                            $currentMonth = date("M");
                                              ...
                                              // Insert Data
                                                $dataArray["insert_status"] = OwnerServiceSalesDataForGraphsLastYear::INSERTED;
