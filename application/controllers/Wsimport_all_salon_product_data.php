...
class Wsimport_all_salon_product_data extends CI_Controller {
	...
	**/
     ...
     */   
    function getProductSales($startDate="",$endDate="",$account_no="")
    {
           ...
           foreach($getConfigDetails->result_array() as $configDetails)
            {
                ...
                if(isset($this->millResponseXml['ProductSales']))
                {
                    ...
                    foreach($this->millResponseXml['ProductSales'] as $pSales) 
                    {
                        ...
                        //array_walk($pSales, function (&$value) { $value = trim($value);});
                        ...
                        if(!empty($arrProductSales))
                        {
                            ...
                            else
                            {
                              //  $pSales['insertedDate'] = date("Y-m-d H:i:s");
                                ...
                                $pSales['insert_status'] = Wsimport_all_salon_product_data::UPDATED;
                        ...
                        else // INSERT APPOINTMENT DATA IN DB 
                        {
                            ...
                            $pSales['insertedDate'] = date("Y-m-d H:i:s");
                            $pSales['updatedDate'] = date("Y-m-d H:i:s");
                            $pSales['insert_status'] = Wsimport_all_salon_product_data::INSERTED;
