<?php
 ...
 class Wsimport_all_salon_gift_card_data_today extends CI_Controller {
   /**
       AUTHOR: Subbu
    ...
    public function GetGiftCertificatesSales($salon_code_encode=""){
			...
			if($getConfigDetails->num_rows()>0)
			{
				foreach($getConfigDetails->result_array() as $configDetails)
				{
		            ...
		            $log['CronUrl'] = MAIN_SERVER_URL.'Wsimport_all_salon_gift_card_data_today/GetGiftCertificatesSales/'.$salon_code_encode;
		            $log['CronType'] = 0;
		            $log['id'] = 0;
