...
class Wsimport_all_salon_product_data_today extends CI_Controller {
           ...
           foreach($getConfigDetails->result_array() as $configDetails)
            {
               ...
               // $log['CronUrl'] = 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                $log['CronUrl'] = MAIN_SERVER_URL.'Wsimport_all_salon_product_data_today/getProductSales/'.$salon_code_encode;
                $log['CronType'] = 0;
                $log['id'] = 0;
