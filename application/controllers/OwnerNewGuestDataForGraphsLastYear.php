...
class OwnerNewGuestDataForGraphsLastYear extends CI_Controller
{
    /**
    AUTHOR: Subbu
    ...
    **/
     ...
     */
    function setOwnerNewGuestDataForGraphsLastYear($dayRangeType="today",$year=1,$salon_id="")
        { 
                ...
                foreach($getAllSalons["mill_salons"] as $salonsData)
                {
                    ...
                    if(!in_array($salon_id, $processedSalons))
                    {
                       ...
                       if(!empty($salonDetails)&& isset($salonDetails['salon_info']["millennium_enabled"]) && $salonDetails['salon_info']["millennium_enabled"]=="Yes"){
                        ...
                        $log['whichCron'] = 'setOwnerNewGuestDataForGraphsLastYear';
                                        ...
                                        if(!empty($reportsDataForSalon)){
                                             ...
                                             if(empty($diff_array)){
                                               pa('No Updates');
                                                ...
                                                // update
                                                $diff_array['insert_status'] = OwnerNewGuestDataForGraphsLastYear::UPDATED;
                                              ...
                                              // Insert Data
                                                $dataArray["insert_status"] = OwnerNewGuestDataForGraphsLastYear::INSERTED;
