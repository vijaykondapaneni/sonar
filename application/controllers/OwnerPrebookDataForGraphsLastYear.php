...
class OwnerPrebookDataForGraphsLastYear extends CI_Controller
{
    /**
    AUTHOR: Subbu
    ...
    **/
     ...
     */
    function setOwnerPrebookDataForGraphsLastYear($dayRangeType="today",$year=1,$salon_id="")
        { 
            ...
            if(isset($getAllSalons["mill_salons"]) && !empty($getAllSalons["mill_salons"]))
            {
                foreach($getAllSalons["mill_salons"] as $salonsData)
                {
                    ...
                    if(!in_array($salon_id, $processedSalons))
                    {
                        ...
                        $log['whichCron'] = 'setOwnerPrebookDataForGraphsLastYear';
                                        ...
                                        if(!empty($reportsDataForSalon)){
                                             ...
                                             if(empty($diff_array)){
                                              pa('No Updates');
                                                ...
                                                // update
                                                $diff_array['insert_status'] = OwnerPrebookDataForGraphsLastYear::UPDATED;
                                              ...
                                              // Insert Data
                                                $dataArray["insert_status"] = OwnerPrebookDataForGraphsLastYear::INSERTED;
