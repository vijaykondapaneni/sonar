...
class Wsimport_millsdk_past_appts_today extends CI_Controller {
	/**
       AUTHOR: Subbu
   ...
   function __construct() {
     ...
     */
	public function getPastAppointments($salon_code_encode=""){
