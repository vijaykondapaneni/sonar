...
class OwnerRetailSalesDataForGraphsLastYear extends CI_Controller
{
    /**
    AUTHOR: Subbu
    ...
    **/
                    ...
                    if($dayRangeType=="Yearly"){
                        ...
                        foreach ($relatedSalons as $eachSalon) {
                            ...
                            foreach ($daterange as $key => $date) {
                               ...
                               $salesArray[$monthName]['dates']['retail']['start_date'] = $firstDayOfMonth;
                                $salesArray[$monthName]['dates']['retail']['end_date'] = $lastdayOfMonth; 
                            }
                            if(!empty($salesArray)){
                                $tempArr = array();
                                foreach ($salesArray as $month_week_name => $dayRanges) {
                                   ...
                                   $totalSales["start_date"] = $datesArray['retail']['start_date'];
                                   $totalSales["end_date"] = $datesArray['retail']['end_date'];
     ...
     */
    function setOwnerRetailSalesDataForGraphsLastYear($dayRangeType="today",$year=1,$salon_id="")
        { 
                ...
                foreach($getAllSalons["mill_salons"] as $salonsData)
                {
                  ...
                  if(!in_array($salon_id, $processedSalons))
                    ...
                    if(!empty($salonDetails)&& isset($salonDetails['salon_info']["millennium_enabled"]) && $salonDetails['salon_info']["millennium_enabled"]=="Yes"){
                        ...
                        $log['whichCron'] = 'setOwnerRetailSalesDataForGraphsLastYear';
                                        ...
                                        if(!empty($reportsDataForSalon)){
                                             ...
                                             if(empty($diff_array)){
                                               pa('No Updates');
                                                ...
                                                // update
                                                $diff_array['insert_status'] = OwnerRetailSalesDataForGraphsLastYear::UPDATED;
                                              ...
                                              // Insert Data
                                                $dataArray["insert_status"] = OwnerRetailSalesDataForGraphsLastYear::INSERTED;
