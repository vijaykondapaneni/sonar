...
class Webserviceaccess {    
    ...
    */
    protected function getSignature($service_url,$salon_id,$timestamp){
       print "<br/>";
       print $host = self::REPORTS_SERVER_URL;
       print "<br/>";
       print $private_key = self::REPORTS_PRIVATEKEY;
       print "<br/>";
       print $uri = $service_url;
       //$params['TimeStamp'] = urldecode($timestamp);
       print "<br/>";
       print $params['TimeStamp'] = $timestamp;
       print "<br/>";
       print $salon_id;
       print "<br/>";
    ...
    public function validateWebAppWs($service_url,$salon_id){
        ...
        {
            print $getSignature  = $this->getSignature($service_url,$salon_id,$this->Timestamp);
            print "<br/>";
