...
class OwnerReportsForDashboard extends CI_Controller
{
    ...
    **/
       ...
       if(!empty($data["salon_id"]) && !empty($data["start_date"]) && !empty($data["end_date"]))
            {
               ...
               // pa($this->db->last_query());
                $dataArray['total_service_sales'] = (!empty($getTotalServiceSales['nprice']) && $getTotalServiceSales['nprice'] > 0 ) ? $this->Common_model->appCloudNumberFormat($getTotalServiceSales['nprice'],2)  : '0.00';
     ...
     */
    function setOwnerReportsDashboard($dayRangeType="today",$salon_id="")
        { 
            ...
            if(isset($getAllSalons["mill_salons"]) && !empty($getAllSalons["mill_salons"]))
            {
                foreach($getAllSalons["mill_salons"] as $salonsData)
                {
                    ...
                    if(!empty($salonDetails)&& isset($salonDetails['salon_info']["millennium_enabled"]) && isset($salonDetails['salon_info']["service_retail_reports_enabled"]) && $salonDetails['salon_info']["millennium_enabled"]=="Yes" && $salonDetails['salon_info']["service_retail_reports_enabled"]=="Yes"){
                        ...
                        $temp1['report_type'] = "currentYearReport";
                        $temp1['dayRangeType'] = !empty($dayRangeType)?$dayRangeType:'';

                        $temp1['total_sales'] = isset($res["total_sales"]) && !empty($res["total_sales"]) && $res["total_sales"]!="0.00" ? $res['total_sales']:'0';


                        $temp1['service_revenue'] = isset($res["total_service_sales"]) && !empty($res["total_service_sales"]) && $res["total_service_sales"]!="0.00" ? $res['total_service_sales']:'0';
                        $temp1['total_retail_price'] = isset($res["total_retail_sales"]) && !empty($res["total_retail_sales"]) && $res["total_retail_sales"]!="0.00" ? $res['total_retail_sales']:'0';
                        $temp1['gift_cards'] = isset($res["total_gift_card_sales"]) && !empty($res["total_gift_card_sales"]) && $res["total_gift_card_sales"]!="0.00" ? $res['total_gift_card_sales']:'0';
                        $temp1['color_revenue'] = isset($res["total_color_service_sales"]) && !empty($res["total_color_service_sales"]) && $res["total_color_service_sales"]!="0.00" ? $res['total_color_service_sales']:'0';
                        $temp1['color_percentage'] = isset($res["color_percentage"]) && !empty($res["color_percentage"]) && $res["color_percentage"]!="0.00" ? $res['color_percentage']:'0';
                        ...
                        $temp1['RPCT'] = isset($res["RPCT"]) && !empty($res["RPCT"]) && $res["RPCT"]!="0" ? $res['RPCT']:'0';
                        $temp1['avg_service_ticket'] = isset($res["avgServiceTicket"]) && !empty($res["avgServiceTicket"]) && $res["avgServiceTicket"]!="0" ? $res['avgServiceTicket']:'0';
                        $temp1['avg_retail_ticket'] = isset($res["avgRetailTicket"]) && !empty($res["avgRetailTicket"]) && $res["avgRetailTicket"]!="0" ? $res['avgRetailTicket']:'0';
                        $temp1['prebook_percentage'] = isset($res["prebook_percentage"]) && !empty($res["prebook_percentage"]) && $res["prebook_percentage"]!="0" ? $res['prebook_percentage']:'0';
                        ...
                        $temp1['RPST'] = isset($res["RPST"]) && !empty($res["RPST"]) ? $res['RPST']:'0';
                        $temp1['client_served'] = isset($res["client_served"]) && !empty($res["client_served"]) ? $res['client_served']:'0';
                        $temp1['RUCT'] = isset($res["RUCT"]) && !empty($res["RUCT"]) ? $res['RUCT']:'0';
                        $temp1['rebook_percentage'] = isset($res["rebook_percentage"]) && !empty($res["rebook_percentage"]) ? $res['rebook_percentage']:'0';
                        ...
                        $temp1['highest_avg_rpct_value'] = isset($res["highest_avg_rpct_value"]) && !empty($res["highest_avg_rpct_value"]) && $res["highest_avg_rpct_value"]!="0.00" ? $res['highest_avg_rpct_value']:'0';
                       ...
                       $temp1['highest_avg_serviceTicket_value'] = isset($res["highest_avg_serviceTicket_value"]) && !empty($res["highest_avg_serviceTicket_value"]) && $res["highest_avg_serviceTicket_value"]!="0.00" ? $res['highest_avg_serviceTicket_value']:'0';
                       ...
                       if(isset($res["highest_avg_serviceTicket_employee_iid"]) && !empty($res["highest_avg_serviceTicket_employee_iid"]))
                        ...
                        $temp1['highest_prebook_value'] = isset($res["highest_prebook_value"]) && !empty($res["highest_prebook_value"]) && $res["highest_prebook_value"]!="0.00" ? $res['highest_prebook_value']:'0';
                        ...
                        $temp1['highest_product_revenue_value'] = isset($res["highest_retail_total_value"]) && !empty($res["highest_retail_total_value"]) && $res["highest_retail_total_value"]!="0.00" ? $res['highest_retail_total_value']:'0';
                        ...
                        $temp1['highest_service_revenue_value'] = isset($res["highest_service_total_value"]) && !empty($res["highest_service_total_value"]) && $res["highest_service_total_value"]!="0.00" ? $res['highest_service_total_value']:'0';
                        ...
                        $temp1['highest_rebook_value'] = isset($res["highest_prebook_value"]) && !empty($res["highest_prebook_value"]) && $res["highest_prebook_value"]!="0.00" ? $res['highest_prebook_value']:'0';
                       ...
                       if(!empty($reportsDataForSalon))
                        {
                            ...
                            else
                            {
                                ...
                                try {
                                    $reportsWhere = array('salon_id' => $salon_id,'report_type' => 'currentYearReport','dayRangeType' => $dayRangeType,'start_date' => $this->startDate,'end_date' => $this->endDate);
