...
table, th, td {
    ...
    <body>
         <div class="container">
         <h1><?php echo $salon_id;?> -- <?php echo $salon_name;?> -- Weekly</h1>
        ...
        ?>
          <?php  foreach ($all_results as $results=>$val){ 
            ...
            <tr>
              <td> <?= "Week" . $i++; ?></td>
              <td> 
                  <?= $val['start_date'] . "--" . $val['end_date']; ?> <br/>
                  <?= $val['lastyear_start_date'] . "-" . $val['lastyear_end_date']; ?>
              </td>
             ...
             <td> <?= $val['sdk_service_current_value']; ?></td>
              <td>
                ...
                <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/Services/<?php echo $val['salon_id']?>/<?php echo $start_date;?>/<?php echo $end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a>  <br/><?php } ?>
              ...
              <td>
                ...
                ?> 
                <span style="color:black;background-color: #ff1919;">  
                <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/Services/<?php echo $val['salon_id']?>/<?php echo $lastyear_start_date;?>/<?php echo $lastyear_end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a>  <br/><?php } ?>
              ...
              <td>
                ...
                ?> 
                <span style="color:black;background-color: #ff1919;">  
                <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/Products/<?php echo $val['salon_id']?>/<?php echo $start_date;?>/<?php echo $end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a> <br/>
                <?php }?>
              ...
              <td>
                ...
                ?> 
                <span style="color:black;background-color: #ff1919;">  
                <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/Products/<?php echo $val['salon_id']?>/<?php echo $lastyear_start_date;?>/<?php echo $lastyear_end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a> <br/>
                <?php }?>
              ...
              <td>
                ...
                ?> 
                <span style="color:black;background-color: #ff1919;">
                 <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/GiftCards/<?php echo $val['salon_id']?>/<?php echo $start_date;?>/<?php echo $end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a> <br/>
                  <?php }?>
              ...
              <td>
                ...
                ?> 
                <span style="color:black;background-color: #ff1919;">
                 <a href="<?php echo MAIN_SERVER_URL;?>NumbersMatch/GiftCards/<?php echo $val['salon_id']?>/<?php echo $lastyear_start_date;?>/<?php echo $lastyear_end_date;?>/<?php echo $dayRangeType;?>/Monthly" target="_blank">Click Here </a> <br/>
                  <?php }?>
