...
<div class="container">
	<div class="row main">
		<div class="main-login main-center">
				...
				<div class="form-group ">
					<input id="salon_weekdays" class="btn btn-primary" style="margin-top:1px;" name="salon_weekdays" value="Get Status" type="button">
				</div>
		</div>
	</div>
	<div class="">
...
<script type="text/javascript">
 $('#salon_weekdays').click(function(){
        ...
        $.post( "<?php echo base_url();?>MillSdkReports/getSalonWeekDaysData",qStr,function(data) {
